...
(pkg-install 'travis 'yaml-mode 'docker 'docker-compose-mode 'dockerfile-mode
             ...
             'auto-complete
             'company 'whitespace-cleanup-mode
             'flycheck
             'flycheck-mix
             'flycheck-rebar3
...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (elpy python-mode groovy-mode gradle-mode exec-path-from-shell js-auto-format-mode whitespace-cleanup-mode web-mode travis flycheck-yamllint flycheck-title flycheck-rebar3 flycheck-pos-tip flycheck-mix flycheck-color-mode-line flycheck-checkbashisms dockerfile-mode docker-compose-mode docker ac-alchemist)))
...
;;==================================================================
;; Ref [](https://github.com/syohex/emacs-ac-alchemist)
...
;;Ref [](https://github.com/auto-complete/auto-complete/issues/191)
(defun plg-ac-config()
